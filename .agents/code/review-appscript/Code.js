...
function handleNotify(data) {
  ...
  const subject = 'COSMOS Encyclopedia — articles ready for review';
  const body = 'Hi ' + (reviewer_name || 'there') + ',\n\n'
    + 'Thank you for your help with reviewing COSMOS encyclopedia articles.\n\n'
    + 'New articles are ready for your review. You can review as many or as few as you like in one session — just click Approve, suggest Corrections, or Skip for each article.\n\n'
    + 'Review here:\n' + reviewUrl + '\n\n'
    + 'Best regards,\n'
    + 'COSMOS Encyclopedia Team';
