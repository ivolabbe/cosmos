...
### Consolidation criteria (5,124 → 2,096 pages)
...
- **644 original COSMOS articles** (from articles_orig/, excluding duplicates) cross-referenced against the glossary.
- **323 matched** to glossary entries (by slug matching with plural/singular variants).
- **329 COSMOS-only articles** added (not found in any glossary source).
- COSMOS-only entries scored from topic-scores.md where available, LLM-scored otherwise.
- The `cosmos` column shows the article slug where a COSMOS page exists.
...
| **Final encyclopedia pages** | **2,096** |

## Score Distribution

Popularity: 10=4 9=107 8=92 7=142 6=192 5=344 4=496 3=492 2=194 1=33
Importance: 10=266 9=285 8=219 7=698 6=251 5=272 4=87 3=7 2=11 1=0
